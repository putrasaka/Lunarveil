...
export default function CreativeProcess({ onNavigateToGallery }: CreativeProcessProps) {
  ...
  const processes = [
    ...
    },
    {
      ...
      icon: Sparkles,
      image: "/images/IMG-20260717-WA0034.jpg",
  ...
  const marqueeImages = [
    "/images/IMG-20260717-WA0004.jpg",
    "/images/IMG-20260717-WA0005.jpg",
    "/images/IMG-20260717-WA0006.jpg",
    "/images/IMG-20260717-WA0007.jpg",
    "/images/IMG-20260717-WA0034.jpg"
  ];
